...
class Wallet:
    ...
    Allows a miner to authorise transactions.
    """
    ...
    def serialise_public_key(self):
        """
        Reset the public key to its serialised version.
        """
    ...
    def verify(public_key, data, signature):
        ...
        deserialised_public_key = serialization.load_pem_public_key(
        ...
        try:
            deserialised_public_key.verify(
